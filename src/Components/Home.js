    ...
    <div>
        ...
        <Carousel>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <h3 style={{ color: "#333" }}>
                FIND YOUR NEW BEST FRIEND, ADOPT AN ANIMAL TODAY
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
      ...
      <section id="ChooseAnimal">
        ...
        <div className="ModalContainer ">
          <div>
            <img className="AnimalModal" src={Dogs} alt="About Us" />
            <ModalDog />
          </div>
          <div>
        ...
        <div className="AboutUsContainer ">
          <div className="AboutUsText ">
            ...
            <p style={{ fontSize: "18px" }}>
              Welcome to our animal adoption website! Our mission is to provide
              a loving home to every dog and cat in need. We are dedicated to
              saving the lives of these furry friends and finding them a forever
              home where they can be happy and loved.<br></br>
              At our adoption center, you can browse through a variety of dogs
              and cats who are looking for a loving family to call their own. We
              have everything from playful puppies and kittens to mature dogs
              and cats who are already trained and well-behaved.<br></br>
            </p>
          </div>
      ...
      <section id="Partners">
        <h1 style={{ textAlign: "left", padding: "0px 40px" }}>
